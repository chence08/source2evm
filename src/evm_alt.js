...
function for_loop_body(expr) {
    return (0, list_1.head)((0, list_1.tail)((0, list_1.tail)((0, list_1.tail)((0, list_1.tail)(expr)))));
}
...
function compile_for_loop(expr, closure_lookup) {
    ...
    const new_declarations = (0, list_1.head)(scan_out_declarations(init_expression));
    ...
    const true_offset = (0, Opcode_1.PUSH4)(0)
        ...
        + Opcode_1.opCodes.JUMPDEST;
    const false_offset = (0, Opcode_1.PUSH4)(0) + Opcode_1.opCodes.ADD + Opcode_1.opCodes.JUMP
        + Opcode_1.opCodes.JUMPDEST
        + body + _update
        + Opcode_1.opCodes.DUP1 + (0, Opcode_1.PUSH)(0) + Opcode_1.opCodes.ADD + Opcode_1.opCodes.JUMP + Opcode_1.opCodes.JUMPDEST;
    ;
    const true_len = true_offset.length / 2;
    const false_len = false_offset.length / 2;
    return _init + Opcode_1.opCodes.PC + Opcode_1.opCodes.JUMPDEST + _test +
        +Opcode_1.opCodes.PC + (0, Opcode_1.PUSH4)(true_len)
        + Opcode_1.opCodes.ADD + Opcode_1.opCodes.JUMPI
        // if true, jump to loop body 
        // end loop otherwise
        + Opcode_1.opCodes.POP + Opcode_1.opCodes.PC + (0, Opcode_1.PUSH4)(false_len) + Opcode_1.opCodes.ADD + Opcode_1.opCodes.JUMP
        + Opcode_1.opCodes.JUMPDEST
        + body + _update
...
function compile_application(expr, closure_lookup) {
    ...
    if (is_lambda_expression(function_expr)) {
        ...
        constants = constants + Opcode_1.opCodes.JUMPDEST + lambda_code + Opcode_1.opCodes.SWAP1 + Opcode_1.opCodes.JUMP;
        const this_offset = CONST_OFFSET;
        CONST_OFFSET = INIT_CODE_LENGTH + constants.length / 2;
        const load_args_and_jump = arg_code + (0, Opcode_1.PUSH4)(this_offset) + Opcode_1.opCodes.JUMP + Opcode_1.opCodes.JUMPDEST;
        return Opcode_1.opCodes.PC + (0, Opcode_1.PUSH4)((load_args_and_jump.length / 2) + 6) + Opcode_1.opCodes.ADD + load_args_and_jump;
    }
    else {
...
exports.default = parse_and_compile;
